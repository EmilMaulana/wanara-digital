    ...
    <div className="bg-black text-white">
      ...
      <main>
        ...
        <section
          ...
          style={{ backgroundImage: "url('/hero-bg.jpg')" }} // Anda bisa mengganti dengan gambar latar yang sesuai
        >
        ...
        <section id="about" className="py-20 bg-gray-900">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-gray-400 max-w-3xl mx-auto text-lg">
              **wanara.digital** lahir dari semangat untuk inovasi dan keunggulan dalam teknologi. Kami adalah tim developer, desainer, dan ahli strategi yang berdedikasi untuk mengubah ide brilian menjadi produk digital yang sukses. Misi kami adalah memberdayakan bisnis melalui solusi perangkat lunak yang dirancang secara presisi dan elegan.
            </p>
          </div>
        </section>
